...
class LensCalculatorService:
    ...
    @staticmethod
    def select_both_eyes_tab(page: Page):
        """両眼タブを選択"""
    ...
    @staticmethod
    def fill_measurement_data(page: Page, data: dict):
        """測定データを入力"""
        frame = page.frame_locator('#calculatorFrame')
    ...
    @staticmethod
    def select_lens_type(page: Page, data: dict):
        """レンズタイプを選択"""
        frame = page.frame_locator('#calculatorFrame')
    ...
    @staticmethod
    def fill_ata_wtw_data(page: Page, data: dict):
        """ATA/WTWデータを入力"""
        frame = page.frame_locator('#calculatorFrame')
